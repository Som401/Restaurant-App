...
import 'package:frontend/pages/reservation_client_info_page.dart';

class TableReservationInfoPage extends StatefulWidget {
  const TableReservationInfoPage({super.key});

  @override
  State<TableReservationInfoPage> createState() =>
      _TableReservationInfoPageState();
}

class _TableReservationInfoPageState extends State<TableReservationInfoPage> {
                ...
                child: MyButton(
                  ...
                  onTap: () async {
                    ...
                    final reservationData = await Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => ReservationClientInfoPage(
